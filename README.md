...
R package **gdx**, version **1.51.6.9010**
...
Dietrich J, Giannousakis A, Bonsch M (2024). _gdx: Interface package for GDX files in R_. doi:10.5281/zenodo.1158598 <https://doi.org/10.5281/zenodo.1158598>, R package version 1.51.6.9010, <https://github.com/pik-piam/gdx>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 1.51.6.9010},
